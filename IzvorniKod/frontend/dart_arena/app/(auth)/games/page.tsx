      ...
      <div className="w-[55%] h-full bg-yellow flex flex-col gap-3 pt-5">
        ...
        <div className="flex flex-col gap-3 w-full h-[88%]">
          <div className="flex justify-between items-center p-7 bg-modalBg rounded-lg shadow-lg shadow-modalShadow hover:scale-[102%] transition duration-300">
            <div className="font-semibold text-2xl flex items-center gap-2"><GiTargetArrows/>X01</div>
          ...
          <div className="flex justify-between items-center p-7 bg-modalBg rounded-lg shadow-lg shadow-modalShadow hover:scale-[102%] transition duration-300">
            <div className="font-semibold text-2xl flex items-center gap-2"><GiTargetArrows/>CRICKET</div>
            <div className="w-[50%] flex justify-end">
          ...
          <div className="flex justify-between items-center p-7 bg-modalBg rounded-lg shadow-lg shadow-modalShadow hover:scale-[102%] transition duration-300">
            <div className="font-semibold text-2xl flex items-center gap-2"><GiTargetArrows/>SHANGHAI</div>
            <div className="w-[50%] flex justify-end">
          ...
          <div className="flex justify-between items-center p-7 bg-modalBg rounded-lg shadow-lg shadow-modalShadow hover:scale-[102%] transition duration-300">
            <div className="font-semibold text-2xl flex items-center gap-2"><GiTargetArrows/>SPLIT UP</div>
            <div className="w-[50%] flex justify-end">
          ...
          <div className="flex justify-between items-center p-7 bg-modalBg rounded-lg shadow-lg shadow-modalShadow hover:scale-[102%] transition duration-300">
            <div className="font-semibold text-2xl flex items-center gap-2"><GiTargetArrows/>COUNT UP</div>
            <div className="w-[50%] flex justify-end">
